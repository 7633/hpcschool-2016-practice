...
Репозиторий содержит следующие директории и файлы:
  ...
  - `include` - заголовочные файлы модулей библиотеки `hpc_2016_logo_detection_lib`:
    `detection` - модуль, с помощью которого решаются основные задачи;
    `benchmark` - вспомогательный модуль для решения дополнительной задачи
    оценки качества работы детектора.
...
### Детальная инструкция по выполнению работы
  ...
  1. Дополнить заголовочный файл `include\detection.hpp` объявлением 
     ...
     Замечания:
       ...
       1. `cv::CascadeClassifier` - класс библиотеки OpenCV, используемый
       ...
       1. `cv::Mat` - тип данных библиотеки OpenCV, используемый для хранения
          изображений.
       1. `cv::Rect` - тип данных библиотеки OpenCV, используемый для преставления
          прямоугольника.
